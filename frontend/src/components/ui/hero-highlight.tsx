...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={`group relative flex w-full items-center justify-center bg-white ${containerClassName || ''}`}
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={`relative inline-block rounded-lg bg-gradient-to-r from-cyan-400 to-teal-500 px-2 pb-1 ${className || ''}`}
    >
      {children}
    </motion.span>
  );
